...
%>  
<table style="width:21cm;table-layout:fixed;" cellpadding="0" cellspacing="0" style="border: none;border-collapse:collapse" >
 <THEAD style="display:table-header-group;">  
		...
		<tr width="756px">
			<td colspan="26" style="border: 0px">
				产品编号：<%=mo.getMaterialId()%>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp产品名称：<%=mo.getMaterialName()%>
			</td>
		...
		<tr width="756px">
			<td colspan="2" rowspan="2"  style="width:2cm;">
				物料编号
			</td>
			<td colspan="6" rowspan="2"  style="width:7cm;">
				名称
			</td>
			<td colspan="1" rowspan="2" style="width:0.5cm;">
				批<br>
				次<br>
				类<br>
				型<br>
			...
			<td colspan="2" rowspan="2"  style="width:1cm;">
				单耗
			</td>
			<td colspan="2" rowspan="2" nowrap="nowrap" style="width:1cm;">
				&nbsp;&nbsp;数量&nbsp;&nbsp;
			</td>
			<td colspan="6" style="width:3cm;">
				实领数量
			</td>
			<td colspan="4" style="width:2cm;">
				型号/数量确认
			</td>
			<td colspan="2" rowspan="2" nowrap="nowrap" style="width:3cm;height:2cm;">
				 &nbsp;&nbsp;备注
			</td>
		</tr>
		<tr>
	...
	while(rs.next())
	    {
			String lotType= "";
			 ...
			 out.println("<tr>");
			 out.println("<td  colspan='2' >"+rs.getString("M_MATERIAL_ID")+"</td>");
			 out.println("<td  colspan='6'   >"+rs.getString("M_NAME") +"</td>");
			 out.println("<td  colspan='1'   >"+lotType+"</td>");
			 out.println("<td  colspan='1'  >"+rs.getString("MB_UOM_ID")+"</td>");
			 out.println("<td  colspan='2'   >"+rs.getBigDecimal("MB_QTY_UNIT")+"</td>");
			 out.println("<td  colspan='2'  >"+rs.getBigDecimal("MO_QTY_PRODUCT")+"</td>");
